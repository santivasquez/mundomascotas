class PlanesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @plane.save
        format.html { redirect_to @plane, notice: 'Plan creado exitosamente' }
  ...
  def update
    respond_to do |format|
      if @plane.update(plane_params)
        format.html { redirect_to @plane, notice: 'Plan actualizado exitosamente' }
  ...
  def destroy
    @plane.destroy
    respond_to do |format|
      format.html { redirect_to planes_url, notice: 'Plan borrado exitosamente.' }
  ...
  private
    ...
    def plane_params
      params.require(:plane).permit(:tipo, :texto)
    end
end
