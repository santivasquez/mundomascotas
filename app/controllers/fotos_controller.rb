class FotosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @foto.save
        format.html { redirect_to @foto, notice: 'Foto Subida' }
  ...
  def update
    respond_to do |format|
      if @foto.update(foto_params)
        format.html { redirect_to @foto, notice: 'Foto actualizada' }
  ...
  def destroy
    @foto.destroy
    respond_to do |format|
      format.html { redirect_to fotos_url, notice: 'Foto borrada' }
  ...
  private
    ...
    def foto_params
      params.require(:foto).permit(:imagen)
    end
end
